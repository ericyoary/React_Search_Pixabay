...
class Search extends React.Component {
	...
	fetchSearchResults = ( updatedPageNo = '', query ) => {
		...
		const searchUrl = `https://pixabay.com/api/?key=18773738-009226495ee90555d0c624e11&q=yellow+flowers&image_type=photo&pretty=true=${query}${pageNumber}`;
	...
	render() {
		...
		return (
			...
			{/*	Heading*/}
			<h2 className="heading">RenTool</h2>
			{/* Search Input*/}
